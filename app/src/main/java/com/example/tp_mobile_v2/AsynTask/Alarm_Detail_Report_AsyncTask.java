...
/**
 * Created by LapTrinhMobile on 12/17/2015.
 */
...
public class Alarm_Detail_Report_AsyncTask extends AsyncTask<String, Item, ArrayList<Item>> {
...
//    private static ProgressDialog pDialog;
    ...
    public Alarm_Detail_Report_AsyncTask (Context ctx, Report report, String inputIP)
    {
        contextCha=ctx;
        adapter = new ArrayAdapter(contextCha, R.layout.my_item_layout, arrItem);
        this.report = report;
        this.IP = inputIP;
//        this.pDialog = new ProgressDialog(ctx);
        LayoutInflater inflater = (LayoutInflater) ctx
                .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        v = inflater.inflate(R.layout.view_detail_report_for_alarm, null);
...
//		ListView txtList = (ListView) contextCha.findViewById(R.id.lvItem);
        ...
        ListView lv1 = (ListView) v.findViewById(R.id.list);
