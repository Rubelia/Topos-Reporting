...
public class Detail_Report_AsynTask extends AsyncTask<String, Item, ArrayList<Item>> {
	...
	public Detail_Report_AsynTask (Activity ctx, Report report, String inputIP)
	{		
		contextCha=ctx;		
